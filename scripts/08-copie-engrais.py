...
Script de copie du fichier Engrais.csv pour le module agricole MAELIA
Auteurs: Cheikhou Akhmed KANE (conversion script: Aboubakry BA)
Description: Copie le fichier Engrais.csv depuis les données brutes vers 
             le répertoire du module agricole MAELIA
...
def afficher_resume(source_path, destination_path):
    ...
    print(f"  • Module : Agricole (Engrais)")
...
def main():
    ...
    """
    print("=" * 70)
    print("COPIE DU FICHIER Engrais.csv")
    print("=" * 70)

    # Définir les chemins
    base_dir = Path(__file__).parent.parent.resolve()
    source_path = base_dir / "data" / "Engrais" / "csv" / "raw" / "Engrais.csv"
    destination_path = base_dir / "tests" / \
        "modeleAgricole" / "Engrais" / "Engrais.csv"
